...
import io.rong.apicloud.translation.ITranslatedMessage;
import io.rong.apicloud.translation.TranslatedConversation;
import io.rong.apicloud.translation.TranslatedConversationNtfyStatus;
import io.rong.apicloud.translation.TranslatedDiscussion;
import io.rong.apicloud.translation.TranslatedMessage;
import io.rong.apicloud.translation.TranslatedQuietHour;
...
public class RongIMClientModule extends UZModule {
    ...
    public void jsmethod_init(final UZModuleContext context) {
        ...
        String key = getFeatureValue("rongCloud2", "appKey");
    ...
    @UzJavascriptMethod
    public void jsmethod_clearNotifications(final UZModuleContext context) {
